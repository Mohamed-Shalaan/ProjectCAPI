...
class Vue extends StatefulWidget {
  const Vue({Key? key}) : super(key: key);

  @override
  _VueState createState() => _VueState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Vue.JS',style: TextStyle(fontSize: 22,color: Colors.black, fontFamily: 'Comfort')),
        centerTitle: true,
              ...
              content: Column(
                children: [
                  Align(
                      ...
                      child: Text('Learn Vue.JS', style: style2)),
                  SizedBox(height: 10,),

                  IconButton(onPressed: () async {
                    const url ='https://www.udemy.com/course/vuejs-2-the-complete-guide/';
