...
class ReactJS extends StatefulWidget {
  ...
  @override
  _ReactJSState createState() => _ReactJSState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('ReactJS',style: TextStyle(fontSize: 22,color: Colors.black, fontFamily: 'Comfort')),
        centerTitle: true,
              ...
              content: Column(
                children: [
                  Align(
                      ...
                      child: Text('Learn ReactJS', style: style2)),
                  SizedBox(height: 10,),

                  IconButton(onPressed: () async {
                    const url ='https://www.coursera.org/projects/into-to-reactjs';
                  ...
                  }, icon: Image.asset('assets/images/coursera.png'), iconSize: 50,),
                ],
              ),
