  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('JavaScript',style: TextStyle(fontSize: 22,color: Colors.black, fontFamily: 'Comfort')),
        centerTitle: true,
              ...
              content: Column(
                children: [
                  Align(
                      ...
                      child: Text('Learn Javascript', style: style2)),
                  SizedBox(height: 10,),

                  IconButton(onPressed: () async {
                    const url ='https://www.javascripttutorial.net/';
                  ...
                  }, icon: Image.asset('assets/images/Javascript.jpg'), iconSize: 50,),
                ],
              ),
